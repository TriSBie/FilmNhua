...
import { Box, Typography, Button, Stack, FormControlLabel, Switch, FormControl, InputLabel, Select, MenuItem, IconButton, } from '@mui/material';
        ...
        { field: 'display', headerName: 'Active', width: 70, type: 'boolean' },
        {
            filed: '', headerName: 'Action', width: 130, renderCell: (params =>
                <Stack direction={'row'} spacing={0} >
                    <FormControlLabel control={<Switch color='error' size='small' checked={params.row.display}
                        onChange={() => {
